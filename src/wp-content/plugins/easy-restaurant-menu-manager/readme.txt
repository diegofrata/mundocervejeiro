...
Donate link: http://saidigital.co
...
* [Project Homepage](http://labs.saidigital.co/products/easy-restaurant-menu-manager-wordpress/)
* [Extended Version](http://labs.saidigital.co/products/easy-restaurant-menu-manager-wordpress/)
* [Support](http://labs.saidigital.co/products/easy-restaurant-menu-manager-wordpress/support/)
* [Daily Specials Add-on](http://labs.saidigital.co/products/easy-restaurant-menu-manager-daily-specials-widget/)
* [Customizing Fonts](http://labs.saidigital.co/products/easy-restaurant-menu-manager-wordpress/custom-fonts-using-css/)
...
* There is an [Extended Version](http://labs.saidigital.co/products/easy-restaurant-menu-manager-wordpress/) with more features and better support.
* There is a [Daily Specials Add-on](http://labs.saidigital.co/products/easy-restaurant-menu-manager-daily-specials-widget/) widget that connects to existing menus and allows you to set specials for each day of the week!
...
Support questions are only answered on our free support forum: [Easy Restaurant Menu Manager for WordPress Support Forum](http://labs.saidigital.co/products/easy-restaurant-menu-manager-wordpress/support/)
